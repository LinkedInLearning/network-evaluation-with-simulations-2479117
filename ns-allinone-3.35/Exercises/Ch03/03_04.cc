...
/*
 * Example of Simulating a UDP Star Topology
 ...
 *        NS_LOG="UdpStar" ./waf --run="scratch/03_04"
 *        NS_LOG="UdpStar" ./waf --run="scratch/03_04 --nNodes=5"
 *        NS_LOG="UdpStar" ./waf --run="scratch/03_04 --nNodes=5 --logging=true"
 */
